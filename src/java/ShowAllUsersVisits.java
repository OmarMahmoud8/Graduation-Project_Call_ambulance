 ...
 * @author GIG
 */
@WebServlet(urlPatterns = {"/ShowAllUsersVisits"})
public class ShowAllUsersVisits extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ShowAllUsersVisits</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            for (int i = 0; i < AllVisit.size(); i++) {
                out.println("<tr> <td>" + AllVisit.get(i).GetVisID() + "</td>"
                        ...
                        + "<td>" + AllVisit.get(i).GetDuration() + " mins</td></tr>");
            }
            out.println("</table>");
